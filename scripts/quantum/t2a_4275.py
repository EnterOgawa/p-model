#!/usr/bin/env python3
"""Generate 8.7.56.4275-.4278 corrected hybrid-reserve return gate artifacts."""
...
import scripts.quantum.t2a_3211 as base
...
base.STEP_TAG = "8.7.56.4275-4278"
base.STEP_NAME = (
...
def _rewrite_outputs() -> None:
    ...
    for kind in ("declaration_gate", "route_sync"):
        ...
        payload["inputs"]["routes"]["next_route"] = "8.7.56.4279"
        payload["inputs"]["routes"]["followup_route"] = "8.7.56.4283"
        payload["summary"]["recommended_next_route_or_none"] = "8.7.56.4279"
        payload["summary"]["selected_followup_route_or_none"] = "8.7.56.4283"
        path.write_text(
...
base.sign_base.payload = lambda step, *args, **kwargs: _ORIGINAL_PAYLOAD(
    "8.7.56.4277" if step == "8.7.56.3213" else step,
    *args,
    **kwargs,
)
