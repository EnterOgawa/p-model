#!/usr/bin/env python3
"""Generate 8.7.56.3167-.3170 corrected pack-refresh return repeat artifacts."""
...
def main() -> None:
    ...
    summary = {
        ...
        "recommended_next_route_or_none": "8.7.56.3171",
        "selected_followup_route_or_none": "8.7.56.3175",
    ...
    payload = sign_base.payload(
        ...
        STEP_NAME + " declaration gate",
        {
            ...
            "routes": {
                ...
                "next_route": "8.7.56.3171",
                "followup_route": "8.7.56.3175",
            },
        },
        rows,
        summary,
