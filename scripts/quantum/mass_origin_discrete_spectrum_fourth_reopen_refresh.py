...
# -*- coding: utf-8 -*-
"""
mass_origin_discrete_spectrum_fourth_reopen_refresh.py

Step 8.7.55.2.417:
Refresh the discrete-spectrum reopen state after the third geometric
binding-selection retry.

Inputs:
  - output/public/quantum/mass_origin_mass_eigenmode_boundary_metrics.json
  - output/public/quantum/mass_origin_geometric_binding_selection_third_retry_metrics.json

Outputs:
  - output/public/quantum/mass_origin_discrete_spectrum_fourth_reopen_refresh_metrics.json
  - output/public/quantum/mass_origin_discrete_spectrum_fourth_reopen_refresh_rows.csv
"""
...
SELECTION_JSON = ROOT / "output" / "public" / "quantum" / "mass_origin_geometric_binding_selection_third_retry_metrics.json"
OUT_JSON = ROOT / "output" / "public" / "quantum" / "mass_origin_discrete_spectrum_fourth_reopen_refresh_metrics.json"
OUT_CSV = ROOT / "output" / "public" / "quantum" / "mass_origin_discrete_spectrum_fourth_reopen_refresh_rows.csv"
DEFAULT_STEP_TAG = "8.7.55.2.417"
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Refresh the discrete-spectrum reopen gate after the third geometric selection retry.")
...
def _build_rows(
    *,
    ...
    return [
        {
            "row_id": "discrete_spectrum_fourth_reopen_refresh_complete",
            "status": "pass",
            "metric": "discrete-spectrum fourth reopen refresh complete",
            "value": 1.0,
            "note": "This step reinjects the third geometric retry result into the mexican-hat mass-eigenmode pilot.",
        },
        {
            "row_id": "selected_binding_route_available",
            "status": "pass" if selected_binding_route_or_none is not None else "reject",
            "metric": "selected geometric binding route available after fourth refresh",
        ...
        },
        {
            ...
            "metric": "discrete spectrum found after fourth reopen refresh",
        ...
        },
        {
            ...
            "status": "inventory",
            "metric": "pilot discrete mode count after fourth reopen refresh",
            "value": float(pilot_mode_count),
            "note": f"Discrete pilot mode count after fourth refresh: {pilot_mode_count}.",
        },
        {
            "row_id": "hand_off_to_8_7_55_2_84",
            "status": "pass" if hand_off_to_8_7_55_2_84 else "reject",
            "metric": "handoff to mass-ratio pilot available after fourth reopen refresh",
...
def _build_payload(step_tag: str) -> Dict[str, Any]:
    ...
    return {
        ...
        "phase": {
            "phase": 8,
            "step": step_tag,
            "name": "discrete-spectrum fourth reopen refresh",
        },
        "inputs": {
            "mass_origin_mass_eigenmode_boundary_json": _relative_str(BOUNDARY_JSON),
            "mass_origin_geometric_binding_selection_third_retry_json": _relative_str(SELECTION_JSON),
        },
        "intent": "Refresh the discrete-spectrum reopen state after the third geometric binding-route selection retry.",
        "formulas": {
        ...
        "decision": {
            "overall_status": (
                "discrete_spectrum_fourth_reopen_refreshed_reopen_ready"
                if hand_off_to_8_7_55_2_84
                else "discrete_spectrum_fourth_reopen_refreshed_still_blocked"
            ),
        ...
        "evidence": {
            ...
            "geometric_binding_selection_third_retry_summary": selection_summary,
        },
    }
