#!/usr/bin/env python3
"""Generate 8.7.56.2903-.2906 corrected mixed-kernel return refresh artifacts."""
...
def main() -> None:
    ...
    older_mixed_kernel_surface_retained = bool(
        older_kernel_summary["updated_pack_mixed_probe_response_kernel_refresh_machine_readable_now"]
        and older_kernel_summary["pure_derivation_forward_scattering_kernel_explicit"]
        and older_kernel_summary["pure_derivation_transverse_projection_surface_explicit"]
    )
    ...
    rows = [
        sign_base.row(
            ...
            "Once the corrected split return is promoted, the honest next move is to restate the corrected mixed-kernel blocker under that return.",
        ),
        sign_base.row(
        ...
        sign_base.row(
            ...
            "The retained scattering-kernel and projector surfaces remain usable after the repeat-reset return.",
        ),
        sign_base.row(
            ...
            "The corrected split return and the retained kernel surfaces now sit on one explicit corrected mixed-kernel return target.",
        ),
        sign_base.row(
    ...
    summary = {
        ...
        "recommended_next_route_or_none": "8.7.56.2907",
        ...
        "selected_followup_route_or_none": "8.7.56.2911",
    ...
    payload = sign_base.payload(
        ...
        STEP_NAME + " declaration gate",
        {
            ...
            "routes": {
                ...
                "next_route": "8.7.56.2907",
                "followup_route": "8.7.56.2911",
            },
        },
        rows,
        summary,
