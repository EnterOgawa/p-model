#!/usr/bin/env python3
"""Generate 8.7.56.3299-.3302 corrected mixed-kernel gate / vacuum refresh artifacts."""
...
def main() -> None:
    ...
    summary = {
        ...
        "recommended_next_route_or_none": "8.7.56.3303",
        ...
        "selected_followup_route_or_none": "8.7.56.3307",
    ...
    payload = sign_base.payload(
        ...
        STEP_NAME + " declaration gate",
        {
            ...
            "routes": {
                ...
                "next_route": "8.7.56.3303",
                "followup_route": "8.7.56.3307",
            },
        },
        rows,
        summary,
