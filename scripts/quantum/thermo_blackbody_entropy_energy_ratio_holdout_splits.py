...
def main() -> None:
    ...
    out_metrics = out_dir / "thermo_blackbody_entropy_energy_ratio_holdout_splits_metrics.json"
        ...
        json.dumps(
            {
                ...
                "notes": [
                    "Analytic holdout for s/u = (4/3) T^-1 based on blackbody entropy and energy densities.",
