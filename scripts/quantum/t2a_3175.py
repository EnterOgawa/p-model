#!/usr/bin/env python3
"""Generate 8.7.56.3175-.3178 corrected probe-split return audit artifacts."""
...
def main() -> None:
    ...
    summary = {
        ...
        "recommended_next_route_or_none": "8.7.56.3179",
        "selected_followup_route_or_none": "8.7.56.3183",
    ...
    payload = sign_base.payload(
        ...
        STEP_NAME + " declaration gate",
        {
            ...
            "routes": {
                ...
                "next_route": "8.7.56.3179",
                "followup_route": "8.7.56.3183",
            },
        },
        rows,
        summary,
