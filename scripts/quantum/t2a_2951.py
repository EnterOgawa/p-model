#!/usr/bin/env python3
"""Generate 8.7.56.2951-.2954 corrected probe-split return audit artifacts."""
...
def main() -> None:
    ...
    summary = {
        ...
        "recommended_next_route_or_none": "8.7.56.2955",
        "selected_followup_route_or_none": "8.7.56.2959",
    ...
    payload = sign_base.payload(
        ...
        STEP_NAME + " declaration gate",
        {
            ...
            "routes": {
                ...
                "next_route": "8.7.56.2955",
                "followup_route": "8.7.56.2959",
            },
        },
        rows,
        summary,
