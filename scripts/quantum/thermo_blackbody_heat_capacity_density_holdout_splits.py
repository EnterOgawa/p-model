"""
目的: 黒体 holdout 監査の heat capacity density 指標図を再生成する。
...
def main() -> None:
    ...
    apply_blackbody_holdout_axes_text(ax, categories=categories, ylabel="test max abs(z)", title="Blackbody heat capacity density holdout: c_v = 4 a T^3")
