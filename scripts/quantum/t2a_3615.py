#!/usr/bin/env python3
"""Generate 8.7.56.3615-.3618 corrected pack-refresh return repeat artifacts."""
...
base.STEP_TAG = "8.7.56.3615-3618"
base.STEP_NAME = (
...
def _rewrite_outputs() -> None:
    ...
    for kind in ("declaration_gate", "route_sync"):
        ...
        payload["inputs"]["routes"]["next_route"] = "8.7.56.3619"
        payload["inputs"]["routes"]["followup_route"] = "8.7.56.3623"
        payload["summary"]["recommended_next_route_or_none"] = "8.7.56.3619"
        payload["summary"]["selected_followup_route_or_none"] = "8.7.56.3623"
        path.write_text(
...
base.sign_base.payload = lambda step, *args, **kwargs: _ORIGINAL_PAYLOAD(
    "8.7.56.3617" if step == "8.7.56.3561" else step,
    *args,
    **kwargs,
)
