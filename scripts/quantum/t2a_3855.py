#!/usr/bin/env python3
"""Generate 8.7.56.3855-.3858 corrected mixed-kernel return refresh artifacts."""
...
import scripts.quantum.t2a_3519 as base
...
base.OLDER_KERNEL_AUDIT = build_metrics_paths(
    base.PUBLIC_OUT,
    build_compact_artifact_stem(
        "8.7.56.3799-3802",
...
base.STEP_TAG = "8.7.56.3855-3858"
base.STEP_NAME = (
...
def _rewrite_outputs() -> None:
    ...
    for kind in ("declaration_gate", "route_sync"):
        ...
        payload["inputs"]["routes"]["next_route"] = "8.7.56.3859"
        payload["inputs"]["routes"]["followup_route"] = "8.7.56.3863"
        payload["summary"]["recommended_next_route_or_none"] = "8.7.56.3859"
        payload["summary"]["selected_followup_route_or_none"] = "8.7.56.3863"
        path.write_text(
...
base.sign_base.payload = lambda step, *args, **kwargs: _ORIGINAL_PAYLOAD(
    "8.7.56.3857" if step == "8.7.56.3521" else step,
    *args,
    **kwargs,
)
