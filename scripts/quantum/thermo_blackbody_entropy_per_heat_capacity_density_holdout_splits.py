"""
目的: 黒体 holdout 監査の entropy per heat capacity density 指標図を再生成する。
...
def main() -> None:
    ...
    apply_blackbody_holdout_axes_text(ax, categories=categories, ylabel="test max abs(z)", title="Blackbody ratio holdout: s/cV = 1/3")
