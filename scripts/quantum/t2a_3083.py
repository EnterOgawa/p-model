#!/usr/bin/env python3
"""Generate 8.7.56.3083-.3086 corrected vacuum-subtraction gate artifacts."""
...
def main() -> None:
    ...
    summary = {
        ...
        "recommended_next_route_or_none": "8.7.56.3087",
        ...
        "selected_followup_route_or_none": "8.7.56.3091",
    ...
    payload = sign_base.payload(
        ...
        STEP_NAME + " declaration gate",
        {
            ...
            "routes": {
                ...
                "next_route": "8.7.56.3087",
                "followup_route": "8.7.56.3091",
            },
        },
        rows,
        summary,
