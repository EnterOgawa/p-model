#!/usr/bin/env python3
"""Generate 8.7.56.4843-.4846 selected-extension-convention-selector selector-axiom gate artifacts."""
...
def build_formulae() -> dict[str, str]:
    """Return formulas used in the selected-extension-convention-selector selector-axiom gate."""
    return {
        "gate_a": (
            "Gate A = exact beyond-current-written-action selected extension "
            "convention selector selected extension convention representative "
            "finite-anchor no-go theorem available now"
        ),
        "gate_b": (
            "Gate B = beyond-current-written-action selected extension convention "
            "selector selector axiom promoted next"
        ),
...
def main() -> None:
    """Execute the selected-extension-convention-selector selector-axiom gate."""
    ...
    rows = [
        sign_base.row(
            "gate_a_updated_pack_exact_beyond_current_written_action_selected_extension_convention_selector_selected_extension_convention_representative_finite_anchor_no_go_available_now",
            "pass" if gate_a else "reject",
            "Gate A exact beyond-current-written-action selected extension convention selector selected extension convention representative finite-anchor no-go available now",
            sign_base.truth(gate_a),
            "The theorem stack now closes that finite anchor conditions still do not choose one canonical selector representative A_conv_ext.",
        ),
        sign_base.row(
            ...
            "Gate B beyond-current-written-action selected extension convention selector selector axiom promoted next",
            sign_base.truth(gate_b),
            "Once finite-anchor representative underdetermination closes theorem-side, the honest next blocker is what selector axiom on A_conv_ext could choose one concrete selected extension.",
        ),
        sign_base.row(
    ...
    summary = {
        ...
        "gate_a_updated_pack_exact_beyond_current_written_action_selected_extension_convention_selector_selected_extension_convention_representative_finite_anchor_no_go_available_now": gate_a,
        "gate_b_updated_pack_beyond_current_written_action_selected_extension_convention_selector_selector_axiom_promoted_next": gate_b,
        "gate_c_farther_hybrid_continuation_reopen_required_now": gate_c,
        "retry_gate_computation_mode_selected": retry_mode,
        "failure_matrix_non_surrogate_guard_preserved": non_surrogate_guard,
        "exact_beyond_current_written_action_selected_extension_convention_selector_selected_extension_convention_representative_available_now": convention_representative_available,
        ...
        "recommended_next_route_or_none": "8.7.56.4847",
        "selected_followup_route": "trial2_numeric_alpha_vector_qball_form_factor_updated_pack_beyond_current_written_action_selected_extension_convention_selector_selector_axiom_gate",
        "selected_followup_route_or_none": "8.7.56.4851",
    ...
    payload = sign_base.payload(
        ...
        STEP_NAME + " declaration gate",
        {
            ...
            "routes": {
                ...
                "next_route": "8.7.56.4847",
                "followup_route": "8.7.56.4851",
            },
        },
        rows,
        summary,
