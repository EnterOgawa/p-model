#!/usr/bin/env python3
"""Generate 8.7.56.4755-.4758 selected-extension-convention-representative gate artifacts."""
...
# 関数: selected-extension-convention-representative gate で使う式を返す。
...
def build_formulae() -> dict[str, str]:
    ...
    return {
        "gate_a": (
            ...
            "convention candidate no-go theorem available now"
        ),
        "gate_b": (
            "Gate B = beyond-current-written-action selected extension "
            "convention representative promoted next"
        ),
...
def main() -> None:
    ...
    rows = [
        sign_base.row(
            ...
            "The theorem stack now closes that convention-candidate choice still reduces to unresolved chart-convention representative choice.",
        ),
        sign_base.row(
            "gate_b_updated_pack_beyond_current_written_action_selected_extension_convention_representative_promoted_next",
            "pass" if gate_b else "reject",
            "Gate B beyond-current-written-action selected extension convention representative promoted next",
            sign_base.truth(gate_b),
            "Once convention-candidate reduction closes, the honest next blocker is which representative convention on chi could be concretely fixed.",
        ),
        sign_base.row(
    ...
    summary = {
        ...
        "gate_a_updated_pack_exact_beyond_current_written_action_selected_extension_convention_candidate_no_go_available_now": gate_a,
        "gate_b_updated_pack_beyond_current_written_action_selected_extension_convention_representative_promoted_next": gate_b,
        "gate_c_farther_hybrid_continuation_reopen_required_now": gate_c,
        "retry_gate_computation_mode_selected": retry_mode,
        "failure_matrix_non_surrogate_guard_preserved": non_surrogate_guard,
        "exact_beyond_current_written_action_selected_extension_convention_candidate_available_now": convention_candidate_available,
        ...
        "recommended_next_route_or_none": "8.7.56.4759",
