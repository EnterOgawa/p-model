#!/usr/bin/env python3
"""Generate 8.7.56.3007-.3010 corrected probe-split return audit artifacts."""
...
def main() -> None:
    ...
    repeat_reset_from_corrected_cycle_explicit = bool(
        prior_repeat_summary["updated_pack_corrected_pack_refresh_return_cycle_exhaustion_machine_readable_now"]
        and prior_repeat_summary["updated_pack_corrected_pack_refresh_return_cycle_repeat_detected"]
        and prior_repeat_summary["updated_pack_corrected_pack_refresh_return_no_new_public_canonical_surface_now"]
    )
    prior_corrected_probe_split_surface_retained = bool(
        older_split_summary["updated_pack_corrected_probe_split_return_machine_readable_now"]
        and older_split_summary["updated_pack_corrected_probe_split_return_target_surface_explicit"]
    )
    ...
    rows = [
        sign_base.row(
            ...
            "After the repeat-detected corrected bookkeeping loop was marked exhausted, the honest move is again to return to the corrected dual-field split.",
        ),
        sign_base.row(
            ...
            "The corrected pack-refresh return loop is already marked exhausted, so the route reset itself remains machine-readable.",
        ),
        sign_base.row(
            ...
            "The earlier corrected probe-split return surface survives the repeat-detected reset and can be reused as the canonical return target.",
        ),
        sign_base.row(
            ...
            "The repeat-reset branch now places the corrected dual-field split back on one explicit return-lane target surface.",
        ),
        sign_base.row(
    ...
    summary = {
        ...
        "recommended_next_route_or_none": "8.7.56.3011",
        "selected_followup_route_or_none": "8.7.56.3015",
    ...
    payload = sign_base.payload(
        ...
        STEP_NAME + " declaration gate",
        {
            ...
            "routes": {
                ...
                "next_route": "8.7.56.3011",
                "followup_route": "8.7.56.3015",
            },
        },
        rows,
        summary,
