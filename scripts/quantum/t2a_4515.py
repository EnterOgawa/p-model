#!/usr/bin/env python3
"""Generate 8.7.56.4515-.4518 corrected pack-refresh return repeat gate artifacts."""
...
base.STEP_TAG = "8.7.56.4515-4518"
base.STEP_NAME = (
...
def _rewrite_outputs() -> None:
    ...
    for kind in ("declaration_gate", "route_sync"):
        ...
        payload["inputs"]["routes"]["next_route"] = "8.7.56.4519"
        payload["inputs"]["routes"]["followup_route"] = "8.7.56.4523"
        payload["summary"]["recommended_next_route_or_none"] = "8.7.56.4519"
        payload["summary"]["selected_followup_route_or_none"] = "8.7.56.4523"
        path.write_text(
...
base.sign_base.payload = lambda step, *args, **kwargs: _ORIGINAL_PAYLOAD(
    "8.7.56.4517" if step == "8.7.56.3565" else step,
    *args,
    **kwargs,
)
