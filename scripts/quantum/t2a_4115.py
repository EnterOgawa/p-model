#!/usr/bin/env python3
"""Generate 8.7.56.4115-.4118 corrected reserve-registry return gate artifacts."""
...
import scripts.quantum.t2a_3219 as base
...
base.STEP_TAG = "8.7.56.4115-4118"
base.STEP_NAME = (
...
base.STEM = build_compact_artifact_stem(
    base.STEP_TAG,
    "updated_pack_corrected_reserve_registry_gate_pack_refresh_return_sync",
    prefix="q",
)
base.PRIOR_CLASS = (
...
def _rewrite_outputs() -> None:
    ...
    for kind in ("declaration_gate", "route_sync"):
        ...
        payload["inputs"]["routes"]["next_route"] = "8.7.56.4119"
        payload["inputs"]["routes"]["followup_route"] = "8.7.56.4123"
        payload["summary"]["recommended_next_route_or_none"] = "8.7.56.4119"
        payload["summary"]["selected_followup_route_or_none"] = "8.7.56.4123"
        path.write_text(
...
base.sign_base.payload = lambda step, *args, **kwargs: _ORIGINAL_PAYLOAD(
    "8.7.56.4117" if step == "8.7.56.3221" else step,
    *args,
    **kwargs,
)
