#!/usr/bin/env python3
"""Generate 8.7.56.3079-.3082 corrected vacuum-subtraction return audit artifacts."""
...
def main() -> None:
    ...
    summary = {
        ...
        "recommended_next_route_or_none": "8.7.56.3083",
        ...
        "selected_followup_route_or_none": "8.7.56.3087",
    ...
    payload = sign_base.payload(
        ...
        STEP_NAME + " declaration gate",
        {
            ...
            "routes": {
                ...
                "next_route": "8.7.56.3083",
                "followup_route": "8.7.56.3087",
            },
        },
        rows,
        summary,
