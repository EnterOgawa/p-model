#!/usr/bin/env python3
"""Generate 8.7.56.2911-.2914 corrected vacuum-subtraction return audit artifacts."""
...
def main() -> None:
    ...
    prior_vacuum_surface_explicit = bool(
        older_vacuum_summary["pure_derivation_vacuum_subtraction_surface_explicit"]
        and older_vacuum_summary["pure_derivation_vacuum_state_surface_explicit"]
        and older_vacuum_summary["pure_derivation_box_divergence_surface_explicit"]
        and older_vacuum_summary["pure_derivation_divergent_vacuum_amplitude_explicit"]
    )
    legacy_warning_retained = bool(
        older_vacuum_summary["legacy_casea_v2_subtraction_worsen_retained"]
        and older_vacuum_summary[
            "legacy_casea_v2_subtraction_noncanonical_for_probe_lane"
        ]
    )
    ...
    rows = [
        ...
        sign_base.row(
            ...
            "The pure-derivation subtraction, vacuum-state, and divergence surfaces remain reusable inside the corrected return lane.",
        ),
        sign_base.row(
