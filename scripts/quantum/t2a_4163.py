#!/usr/bin/env python3
"""Generate 8.7.56.4163-.4166 corrected hybrid-reserve return gate artifacts."""
...
base.STEP_TAG = "8.7.56.4163-4166"
base.STEP_NAME = (
...
def _rewrite_outputs() -> None:
    ...
    for kind in ("declaration_gate", "route_sync"):
        ...
        payload["inputs"]["routes"]["next_route"] = "8.7.56.4167"
        payload["inputs"]["routes"]["followup_route"] = "8.7.56.4171"
        payload["summary"]["recommended_next_route_or_none"] = "8.7.56.4167"
        payload["summary"]["selected_followup_route_or_none"] = "8.7.56.4171"
        path.write_text(
...
base.sign_base.payload = lambda step, *args, **kwargs: _ORIGINAL_PAYLOAD(
    "8.7.56.4165" if step == "8.7.56.3213" else step,
    *args,
    **kwargs,
)
