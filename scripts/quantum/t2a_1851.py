#!/usr/bin/env python3
"""Generate 8.7.56.1851-.1854 post-closeout reactivation audit artifacts."""
...
SIGNED_CLOSEOUT_GATE = (
    PUBLIC_OUT
    / "q_8_7_56_1847_1850_signed_source_phase_closeout_wait_restore_declaration_gate_metrics.json"
)

STEP_TAG = "8.7.56.1851-1854"
STEP_NAME = (
    "Trial-2 numeric alpha vector Q-ball form-factor conditional post-closeout "
    "pack-update or external-input reactivation"
)
STEM = build_compact_artifact_stem(
    STEP_TAG,
    "post_closeout_reactivation_audit",
    prefix="q",
)
...
NEXT_ROUTE_NAME = (
    "trial2_numeric_alpha_vector_qball_form_factor_post_closeout_wait_restore_"
    "dormant_registry"
)
NEXT_ROUTE = "8.7.56.1855"
FOLLOWUP_ROUTE_NAME = (
    "trial2_numeric_alpha_vector_qball_form_factor_conditional_post_dormant_"
    "pack_update_or_external_input_reactivation"
)
FOLLOWUP_ROUTE = "8.7.56.1859"
DOWNLOAD_PATTERNS = (
    "trial2",
    "vector_qball",
    "numeric_alpha",
...
def main() -> None:
    ...
    closeout_summary = read_json(SIGNED_CLOSEOUT_GATE)["summary"]
    ...
    inventory_ready = all(
        (
            bool(closeout_summary["exact_alpha_promotion_retained"]),
            bool(closeout_summary["exact_signed_source_phase_theorem_retained"]),
            bool(closeout_summary["global_signed_form_factor_promotion_retained"]),
        )
    )
    ...
    rows = [
        ...
        row("matching_download_count", "watch", "matching Downloads note count", float(matching_download_count), "Relevant post-closeout notes are detected by filename match over the Trial-2/vector-Qball namespace."),
        row("genuinely_new_external_input_detected", "reject" if not genuinely_new_external_input_detected else "pass", "genuinely new external input detected after closeout", truth(genuinely_new_external_input_detected), "No relevant Downloads note is newer than the retained closeout timestamp, so external reactivation does not open."),
    ...
    summary = {
        ...
        "closeout_threshold_utc": threshold_utc.isoformat(),
    ...
    decision = {
        "overall_status": "vector_qball_form_factor_post_closeout_reactivation_audit_declared",
    ...
    evidence = {
        ...
        "hits": {
            "status_branch_hit": hit(status_text, "8.7.56.1851"),
            "roadmap_branch_hit": hit(roadmap_text, "8.7.56.1851-.1854"),
            ...
            "unified_roadmap_hit": hit(unified_text, "90. `.1851-.1854`"),
            "long_roadmap_hit": hit(long_text, "8.7.56.1851-.1854"),
    ...
    declaration_payload = payload(
        ...
        STEP_NAME + " declaration gate",
        {
            "source_files": {
                ...
                "signed_closeout_gate": display_path(SIGNED_CLOSEOUT_GATE),
    ...
    route_payload = payload(
        ...
        [
            ...
            row("next_route_fixed", "pass", "next route fixed", 1.0, "The next official branch is the post-closeout wait restore / dormant registry sync."),
        ],
        {
            "trial2_numeric_alpha_problem_classification": BRANCH_CLASS,
            "selected_next_generation_route": NEXT_ROUTE_NAME,
        ...
        {
            "overall_status": "vector_qball_form_factor_post_closeout_reactivation_route_synced",
            "branch_completed": True,
            "next_required_artifacts": [NEXT_ROUTE_NAME],
        },
        {"formulas": formulas},
    ...
    print("[ok] 8.7.56.1851-.1854 post-closeout reactivation audit artifacts generated")
