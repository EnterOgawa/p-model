#!/usr/bin/env python3
"""Generate 8.7.56.3139-.3142 corrected vacuum-subtraction gate artifacts."""
...
def main() -> None:
    ...
    summary = {
        ...
        "recommended_next_route_or_none": "8.7.56.3143",
        ...
        "selected_followup_route_or_none": "8.7.56.3147",
    ...
    payload = sign_base.payload(
        ...
        STEP_NAME + " declaration gate",
        {
            ...
            "routes": {
                ...
                "next_route": "8.7.56.3143",
                "followup_route": "8.7.56.3147",
            },
        },
        rows,
        summary,
