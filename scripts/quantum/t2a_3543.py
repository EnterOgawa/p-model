#!/usr/bin/env python3
"""Generate 8.7.56.3543-.3546 corrected hybrid-reserve return audit artifacts."""
...
base.OLDER_HYBRID_AUDIT = build_metrics_paths(
    base.PUBLIC_OUT,
    build_compact_artifact_stem(
        "8.7.56.3487-3490",
...
base.STEP_TAG = "8.7.56.3543-3546"
base.STEP_NAME = (
...
base.BRANCH_CLASS = (
    "vector_qball_form_factor_residual_origin_missing_action_updated_pack_"
    "corrected_hybrid_reserve_return_audited_reserve_registry_refresh_"
    "secondary_gate"
)
...
def _rewrite_outputs() -> None:
    ...
    for kind in ("declaration_gate", "route_sync"):
        ...
        payload["inputs"]["routes"]["next_route"] = "8.7.56.3547"
        payload["inputs"]["routes"]["followup_route"] = "8.7.56.3551"
        payload["summary"]["recommended_next_route_or_none"] = "8.7.56.3547"
        payload["summary"]["selected_followup_route_or_none"] = "8.7.56.3551"
        path.write_text(
...
base.sign_base.payload = lambda step, *args, **kwargs: _ORIGINAL_PAYLOAD(
    "8.7.56.3545" if step == "8.7.56.3209" else step,
    *args,
    **kwargs,
)
