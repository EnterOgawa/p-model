...
# -*- coding: utf-8 -*-
"""
mass_origin_blocked_interface_stack_control_plane_pack_stack_control_plane_audit.py

Step 8.7.55.2.45:
Freeze one top-level control-plane audit for the mass-origin blocked
interface-stack control-plane pack stack, so downstream readers can verify
that the pack-stack manifest, continuity, rerun-policy, and operational-cycle
artifacts still expose the same blocked detail, rerun trigger,
apply-chain signature, and stable no-change-hold contract.

Inputs:
  - output/public/quantum/mass_origin_blocked_interface_stack_control_plane_pack_stack_manifest.json
  - output/public/quantum/mass_origin_blocked_interface_stack_control_plane_pack_stack_continuity_metrics.json
  - output/public/quantum/mass_origin_blocked_interface_stack_control_plane_pack_stack_rerun_policy.json
  - output/public/quantum/mass_origin_blocked_interface_stack_control_plane_pack_stack_operational_cycle.json

Outputs:
  - output/public/quantum/mass_origin_blocked_interface_stack_control_plane_pack_stack_control_plane_metrics.json
  - output/public/quantum/mass_origin_blocked_interface_stack_control_plane_pack_stack_control_plane_rows.csv

Assumptions:
  - This control-plane audit is descriptive only; it does not execute the
    rerun chain and does not reopen the mass-origin branch.
  - The pack-stack control plane is considered settled only when all four
    artifacts agree on blocked detail, latent-route exhaustion, next required
    artifacts, rerun-trigger contract, apply-chain signature, and stable
    no-change-hold.
"""
...
MANIFEST_JSON = PUBLIC_QUANTUM_DIR / "mass_origin_blocked_interface_stack_control_plane_pack_stack_manifest.json"
CONTINUITY_JSON = PUBLIC_QUANTUM_DIR / "mass_origin_blocked_interface_stack_control_plane_pack_stack_continuity_metrics.json"
RERUN_POLICY_JSON = PUBLIC_QUANTUM_DIR / "mass_origin_blocked_interface_stack_control_plane_pack_stack_rerun_policy.json"
OPERATIONAL_CYCLE_JSON = PUBLIC_QUANTUM_DIR / "mass_origin_blocked_interface_stack_control_plane_pack_stack_operational_cycle.json"
OUT_JSON = PUBLIC_QUANTUM_DIR / "mass_origin_blocked_interface_stack_control_plane_pack_stack_control_plane_metrics.json"
OUT_CSV = PUBLIC_QUANTUM_DIR / "mass_origin_blocked_interface_stack_control_plane_pack_stack_control_plane_rows.csv"
DEFAULT_STEP_TAG = "8.7.55.2.45"
...
EXPECTED_RERUN_TRIGGER = "blocked_interface_stack_control_plane_pack_stack_continuity_state_changed"
EXPECTED_MANIFEST_STATUS = "blocked_interface_stack_control_plane_pack_stack_manifest_frozen"
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Freeze the top-level control-plane audit for the mass-origin blocked interface-stack control-plane pack stack.",
    )
    parser.add_argument(
        "--step-tag",
...
def _extract_control_plane_state(
    ...
    return {
        ...
        "manifest_control_plane_pack_stack_complete": _extract_bool(
            manifest,
            [["decision", "control_plane_pack_stack_complete"]],
        ),
        "continuity_control_plane_pack_stack_complete": _extract_bool(
            continuity,
            [["decision", "control_plane_pack_stack_complete"]],
        ),
        "rerun_policy_control_plane_pack_stack_complete": _extract_bool(
            rerun_policy,
            [["decision", "control_plane_pack_stack_complete"]],
        ),
        "operational_cycle_control_plane_pack_stack_complete": _extract_bool(
            operational_cycle,
            [["decision", "control_plane_pack_stack_complete"]],
        ),
        ...
        "control_plane_pack_stack_cycle_signature_sha256": _extract_str(
            operational_cycle,
...
def _build_rows(control_plane_state: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    terminal_statuses = [
        control_plane_state.get("terminal_control_plane_pack_status_manifest", ""),
        control_plane_state.get("terminal_control_plane_pack_status_continuity", ""),
        control_plane_state.get("terminal_control_plane_pack_status_rerun_policy", ""),
        control_plane_state.get("terminal_control_plane_pack_status_operational_cycle", ""),
    ]
    ...
    return [
        {
            ...
            "metric": "blocked-state detail is consistent across the control-plane pack stack control plane",
        ...
        },
        {
            ...
            "metric": "latent reopen-route exhaustion is consistent across the control-plane pack stack control plane",
        ...
        },
        {
            ...
            "metric": "next required artifacts are consistent across the control-plane pack stack control plane",
        ...
        },
        {
            ...
            "metric": "control-plane pack stack manifest remains frozen",
        ...
        },
        {
            ...
            "metric": "control-plane pack stack continuity artifact remains on no-change hold",
        ...
        },
        {
            ...
            "metric": "control-plane pack stack rerun policy remains locked on no-change hold",
        ...
        },
        {
            ...
            "metric": "control-plane pack stack operational cycle remains on no-change hold",
        ...
        },
        {
            ...
            "metric": "terminal control-plane pack status is consistent across the control-plane pack stack control plane",
        ...
        },
        {
            ...
            "metric": "mass-origin branch remains blocked across all control-plane pack stack control-plane layers",
...
def _build_payload(step_tag: str) -> Dict[str, Any]:
    ...
    next_required_artifacts = list(control_plane_state.get("manifest_next_required_artifacts", []))
    control_plane_pack_stack_complete = all(
        [
            bool(control_plane_state.get("manifest_control_plane_pack_stack_complete", False)),
            bool(control_plane_state.get("continuity_control_plane_pack_stack_complete", False)),
            bool(control_plane_state.get("rerun_policy_control_plane_pack_stack_complete", False)),
            bool(control_plane_state.get("operational_cycle_control_plane_pack_stack_complete", False)),
        ]
    )
    control_plane_pack_signature_values = [
        control_plane_state.get("control_plane_pack_signature_manifest", ""),
        control_plane_state.get("control_plane_pack_signature_continuity", ""),
        control_plane_state.get("control_plane_pack_signature_rerun_policy", ""),
        control_plane_state.get("control_plane_pack_signature_operational_cycle", ""),
    ]
    ...
    control_plane_pack_stack_signature_values = [
        control_plane_state.get("control_plane_pack_stack_signature_manifest", ""),
        control_plane_state.get("control_plane_pack_stack_signature_continuity", ""),
        control_plane_state.get("control_plane_pack_stack_signature_rerun_policy", ""),
        control_plane_state.get("control_plane_pack_stack_signature_operational_cycle", ""),
    ]
    ...
    if has_reject:
        ...
        decision_text = "blocked_interface_stack_control_plane_pack_stack_control_plane_inconsistent"
        next_action = "repair_control_plane_pack_stack_control_plane_contract_before_any_refresh"
    # 条件分岐: 前段条件が不成立で、`rerun_required_now` を追加評価する。
    elif rerun_required_now:
        overall_status = "watch"
        decision_text = "blocked_interface_stack_control_plane_pack_stack_control_plane_pending_rerun"
        next_action = "run_mass_origin_blocked_interface_stack_control_plane_pack_stack_chain_in_order"
    # 条件分岐: 前段条件が不成立で、`keep_blocked` を追加評価する。
    elif keep_blocked:
        overall_status = "watch"
        decision_text = "blocked_interface_stack_control_plane_pack_stack_control_plane_locked_no_change_hold"
        next_action = "wait_for_new_public_artifact_then_rerun_control_plane_pack_stack_control_plane_audit"
    else:
        overall_status = "pass"
        decision_text = "blocked_interface_stack_control_plane_pack_stack_control_plane_unblocked_outside_audit"
    ...
    return {
        ...
        "phase": {
            "phase": 8,
            "step": step_tag,
            "name": "mass-origin blocked interface-stack control-plane pack stack control-plane audit",
        },
        "inputs": {
            "blocked_interface_stack_control_plane_pack_stack_manifest_json": _rel(MANIFEST_JSON),
            "blocked_interface_stack_control_plane_pack_stack_continuity_metrics_json": _rel(CONTINUITY_JSON),
            "blocked_interface_stack_control_plane_pack_stack_rerun_policy_json": _rel(RERUN_POLICY_JSON),
            "blocked_interface_stack_control_plane_pack_stack_operational_cycle_json": _rel(OPERATIONAL_CYCLE_JSON),
        },
        "intent": "Freeze one top-level control-plane audit for the current blocked interface-stack control-plane pack stack without executing the rerun chain.",
        "summary": {
            "manifest_phase_step": control_plane_state.get("manifest_phase_step"),
            "continuity_phase_step": control_plane_state.get("continuity_phase_step"),
            "rerun_policy_phase_step": control_plane_state.get("rerun_policy_phase_step"),
            "operational_cycle_phase_step": control_plane_state.get("operational_cycle_phase_step"),
            "manifest_status": control_plane_state.get("manifest_status"),
            "continuity_decision": control_plane_state.get("continuity_decision"),
            "rerun_policy_decision": control_plane_state.get("rerun_policy_decision"),
            "operational_cycle_decision": control_plane_state.get("operational_cycle_decision"),
            "blocked_state_detail": control_plane_state.get("manifest_blocked_state_detail"),
            "latent_reopen_routes_exhausted": bool(
                control_plane_state.get("manifest_latent_reopen_routes_exhausted", False)
            ),
            "terminal_control_plane_pack_status": control_plane_state.get("terminal_control_plane_pack_status_manifest"),
            ...
            "apply_chain_signature_sha256": control_plane_state.get("apply_chain_signature_policy"),
            "control_plane_pack_stack_cycle_signature_sha256": control_plane_state.get("control_plane_pack_stack_cycle_signature_sha256"),
            "control_plane_pack_stack_control_plane_signature_sha256": control_plane_signature,
            "control_plane_pack_stack_complete": control_plane_pack_stack_complete,
        ...
        "decision": {
            ...
            "rerun_trigger": control_plane_state.get("rerun_trigger_policy"),
            "keep_mass_origin_branch_blocked": keep_blocked,
            "blocked_state_detail": control_plane_state.get("manifest_blocked_state_detail"),
            "latent_reopen_routes_exhausted": bool(
                control_plane_state.get("manifest_latent_reopen_routes_exhausted", False)
            ),
            "continuity_no_change_hold": control_plane_state.get("continuity_decision") == EXPECTED_CONTINUITY_DECISION,
        ...
        "evidence": {
            "manifest_artifact": {
                ...
                "phase_step": control_plane_state.get("manifest_phase_step"),
                "status": control_plane_state.get("manifest_status"),
            },
            "continuity_artifact": {
                "path": _rel(CONTINUITY_JSON),
                "phase_step": control_plane_state.get("continuity_phase_step"),
                "decision": control_plane_state.get("continuity_decision"),
            },
            "rerun_policy_artifact": {
                "path": _rel(RERUN_POLICY_JSON),
                "phase_step": control_plane_state.get("rerun_policy_phase_step"),
                "decision": control_plane_state.get("rerun_policy_decision"),
            },
            "operational_cycle_artifact": {
                "path": _rel(OPERATIONAL_CYCLE_JSON),
                "phase_step": control_plane_state.get("operational_cycle_phase_step"),
                "decision": control_plane_state.get("operational_cycle_decision"),
            },
        },
    }
