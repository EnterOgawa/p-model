#!/usr/bin/env python3
"""Generate 8.7.56.3095-.3098 corrected hybrid-reserve return audit artifacts."""
...
def main() -> None:
    ...
    summary = {
        ...
        "recommended_next_route_or_none": "8.7.56.3099",
        ...
        "selected_followup_route_or_none": "8.7.56.3103",
    ...
    payload = sign_base.payload(
        ...
        STEP_NAME + " declaration gate",
        {
            ...
            "routes": {
                ...
                "next_route": "8.7.56.3099",
                "followup_route": "8.7.56.3103",
            },
        },
        rows,
        summary,
