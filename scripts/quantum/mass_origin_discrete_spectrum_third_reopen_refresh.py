...
# -*- coding: utf-8 -*-
"""
mass_origin_discrete_spectrum_third_reopen_refresh.py
...
Inputs:
  ...
  - output/public/quantum/mass_origin_geometric_binding_selection_second_retry_metrics.json

Outputs:
  - output/public/quantum/mass_origin_discrete_spectrum_third_reopen_refresh_metrics.json
  - output/public/quantum/mass_origin_discrete_spectrum_third_reopen_refresh_rows.csv
"""
...
SELECTION_JSON = ROOT / "output" / "public" / "quantum" / "mass_origin_geometric_binding_selection_second_retry_metrics.json"
OUT_JSON = ROOT / "output" / "public" / "quantum" / "mass_origin_discrete_spectrum_third_reopen_refresh_metrics.json"
OUT_CSV = ROOT / "output" / "public" / "quantum" / "mass_origin_discrete_spectrum_third_reopen_refresh_rows.csv"
DEFAULT_STEP_TAG = "8.7.55.2.410"
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Refresh the discrete-spectrum reopen gate after the second geometric selection retry.")
...
def _build_rows(
    *,
    ...
    return [
        {
            "row_id": "discrete_spectrum_third_reopen_refresh_complete",
            "status": "pass",
            "metric": "discrete-spectrum third reopen refresh complete",
            "value": 1.0,
        ...
        },
        {
            ...
            "metric": "selected geometric binding route available after third refresh",
        ...
        },
        {
            ...
            "metric": "discrete spectrum found after third reopen refresh",
        ...
        },
        {
            ...
            "status": "inventory",
            "metric": "pilot discrete mode count after third reopen refresh",
            "value": float(pilot_mode_count),
            "note": f"Discrete pilot mode count after third refresh: {pilot_mode_count}.",
        },
        {
            "row_id": "hand_off_to_8_7_55_2_84",
            "status": "pass" if hand_off_to_8_7_55_2_84 else "reject",
            "metric": "handoff to mass-ratio pilot available after third reopen refresh",
...
def _build_payload(step_tag: str) -> Dict[str, Any]:
    ...
    return {
        ...
        "phase": {
            "phase": 8,
            "step": step_tag,
            "name": "discrete-spectrum third reopen refresh",
        },
        "inputs": {
            "mass_origin_mass_eigenmode_boundary_json": _relative_str(BOUNDARY_JSON),
            "mass_origin_geometric_binding_selection_second_retry_json": _relative_str(SELECTION_JSON),
        },
        "intent": "Refresh the discrete-spectrum reopen state after the second geometric binding-route selection retry.",
        "formulas": {
        ...
        "decision": {
            "overall_status": (
                "discrete_spectrum_third_reopen_refreshed_reopen_ready"
                if hand_off_to_8_7_55_2_84
                else "discrete_spectrum_third_reopen_refreshed_still_blocked"
            ),
        ...
        "evidence": {
            ...
            "geometric_binding_selection_second_retry_summary": selection_summary,
        },
    }
