#!/usr/bin/env python3
"""Generate 8.7.56.2959-.2962 corrected mixed-kernel return refresh artifacts."""
...
def main() -> None:
    ...
    summary = {
        ...
        "recommended_next_route_or_none": "8.7.56.2963",
        ...
        "selected_followup_route_or_none": "8.7.56.2967",
    ...
    payload = sign_base.payload(
        ...
        STEP_NAME + " declaration gate",
        {
            ...
            "routes": {
                ...
                "next_route": "8.7.56.2963",
                "followup_route": "8.7.56.2967",
            },
        },
        rows,
        summary,
