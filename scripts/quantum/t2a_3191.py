#!/usr/bin/env python3
"""Generate 8.7.56.3191-.3194 corrected vacuum-subtraction return audit artifacts."""
...
def main() -> None:
    ...
    summary = {
        ...
        "recommended_next_route_or_none": "8.7.56.3195",
        ...
        "selected_followup_route_or_none": "8.7.56.3199",
    ...
    payload = sign_base.payload(
        ...
        STEP_NAME + " declaration gate",
        {
            ...
            "routes": {
                ...
                "next_route": "8.7.56.3195",
                "followup_route": "8.7.56.3199",
            },
        },
        rows,
        summary,
