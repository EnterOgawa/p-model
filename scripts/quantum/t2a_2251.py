#!/usr/bin/env python3
"""Generate 8.7.56.2251-.2254 hybrid seventh registry-refresh artifacts."""
...
PRIOR_GATE = build_metrics_paths(
    PUBLIC_OUT,
    build_compact_artifact_stem("8.7.56.2247-2250", "harmonic_hybrid_s7_s8_fast", prefix="q"),
    "declaration_gate",
)["json"]

STEP_TAG = "8.7.56.2251-2254"
STEP_NAME = "Trial-2 numeric alpha vector Q-ball form-factor hybrid seventh registry refresh"
STEM = build_compact_artifact_stem(STEP_TAG, "harmonic_hybrid_s7_s8_registry", prefix="q")
...
BRANCH_CLASS_EIGHTH = (
    "vector_qball_form_factor_boundary_bulk_lattice_hybrid_s8_promoted_1474560_next"
)
BRANCH_CLASS_RESET = (
...
NEXT_ROUTE_NAME_EIGHTH = "trial2_numeric_alpha_vector_qball_form_factor_hybrid_s8_farther_audit"
NEXT_ROUTE_NAME_RESET = "trial2_numeric_alpha_vector_qball_form_factor_hybrid_pack_update_review"
NEXT_ROUTE = "8.7.56.2255"
...
def build_formulae() -> dict[str, str]:
    ...
    return {
        "gate_a_rule": "Gate A retains the same seventh segment if the accelerated first shot survives through harmonic 1474560.",
...
def main() -> None:
    ...
    inventory_ready = bool(
        prior_summary["gate_a_same_seventh_piecewise_validation_to_1474560_retained"]
        or prior_summary["gate_b_eighth_piecewise_reactivation_selected"]
        or prior_summary["gate_c_substantive_pack_update_required"]
    )
    gate_a = bool(prior_summary["gate_a_same_seventh_piecewise_validation_to_1474560_retained"])
    ...
    rows = [
        ...
        sign_base.row(
            ...
            "Gate A same seventh validation through harmonic 1474560 retained",
    ...
    declaration_payload = sign_base.payload(
        ...
        summary,
        {
            "overall_status": "vector_qball_form_factor_hybrid_s7_s8_registry_declared",
        ...
        },
        {
            ...
            "hits": {
                "status_branch_hit": find_line(status_text, "8.7.56.2251"),
                "roadmap_branch_hit": find_line(roadmap_text, ".2251-.2254"),
                "current_problem_hit": find_line(current_problem_text, "8.7.56.2251"),
                "current_status_hit": find_line(current_status_text, "8.7.56.2251"),
                "unified_roadmap_hit": find_line(unified_text, ".2251-.2254"),
                "long_roadmap_hit": find_line(long_text, ".2251-.2254"),
                "part5_hit": find_line(part5_text, ".2251-.2254"),
            },
        },
    )
    ...
    route_payload = {
        ...
        "summary": summary,
        "decision": {
            "overall_status": "vector_qball_form_factor_hybrid_s7_s8_registry_route_synced",
            "branch_completed": True,
            "next_required_artifacts": [next_route_name],
        },
