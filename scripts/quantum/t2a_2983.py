#!/usr/bin/env python3
"""Generate 8.7.56.2983-.2986 corrected hybrid-reserve return audit artifacts."""
...
def main() -> None:
    ...
    rows = [
        ...
        sign_base.row(
            ...
            "The corrected reserve-return explicitly keeps farther hybrid continuation closed.",
        ),
    ]
    ...
    payload = sign_base.payload(
        ...
        summary,
        {
            "overall_status": "vector_qball_form_factor_updated_pack_corrected_hybrid_reserve_return_declared",
