#!/usr/bin/env python3
"""Generate 8.7.56.3551-.3554 corrected reserve-registry return audit artifacts."""
...
import scripts.quantum.t2a_3215 as base
...
base.STEP_TAG = "8.7.56.3551-3554"
base.STEP_NAME = (
...
def _rewrite_outputs() -> None:
    ...
    for kind in ("declaration_gate", "route_sync"):
        ...
        payload["inputs"]["routes"]["next_route"] = "8.7.56.3555"
        payload["inputs"]["routes"]["followup_route"] = "8.7.56.3559"
        payload["summary"]["recommended_next_route_or_none"] = "8.7.56.3555"
        payload["summary"]["selected_followup_route_or_none"] = "8.7.56.3559"
        path.write_text(
...
base.sign_base.payload = lambda step, *args, **kwargs: _ORIGINAL_PAYLOAD(
    "8.7.56.3553" if step == "8.7.56.3217" else step,
    *args,
    **kwargs,
)
