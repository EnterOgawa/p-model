#!/usr/bin/env python3
"""Generate 8.7.56.3311-.3314 corrected pack-refresh return audit artifacts."""
...
base.STEP_TAG = "8.7.56.3311-3314"
base.STEP_NAME = (
...
def _rewrite_outputs() -> None:
    ...
    for kind in ("declaration_gate", "route_sync"):
        ...
        payload["inputs"]["routes"]["next_route"] = "8.7.56.3315"
        payload["inputs"]["routes"]["followup_route"] = "8.7.56.3319"
        payload["summary"]["recommended_next_route_or_none"] = "8.7.56.3315"
        payload["summary"]["selected_followup_route_or_none"] = "8.7.56.3319"
        path.write_text(json.dumps(payload, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")


base.sign_base.payload = lambda step, *args, **kwargs: _ORIGINAL_PAYLOAD(
    "8.7.56.3313" if step == "8.7.56.3201" else step,
    *args,
    **kwargs,
)
