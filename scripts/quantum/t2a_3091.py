#!/usr/bin/env python3
"""Generate 8.7.56.3091-.3094 corrected pack-refresh return gate artifacts."""
...
def main() -> None:
    ...
    summary = {
        ...
        "recommended_next_route_or_none": "8.7.56.3095",
        ...
        "selected_followup_route_or_none": "8.7.56.3099",
    ...
    payload = sign_base.payload(
        ...
        STEP_NAME + " declaration gate",
        {
            ...
            "routes": {
                ...
                "next_route": "8.7.56.3095",
                "followup_route": "8.7.56.3099",
            },
        },
        rows,
        summary,
