#!/usr/bin/env python3
"""Generate 8.7.56.2979-.2982 corrected pack-refresh return gate artifacts."""
...
def main() -> None:
    ...
    summary = {
        ...
        "recommended_next_route_or_none": "8.7.56.2983",
        ...
        "selected_followup_route_or_none": "8.7.56.2987",
    ...
    payload = sign_base.payload(
        ...
        STEP_NAME + " declaration gate",
        {
            ...
            "routes": {
                ...
                "next_route": "8.7.56.2983",
                "followup_route": "8.7.56.2987",
            },
        },
        rows,
        summary,
