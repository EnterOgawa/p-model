#!/usr/bin/env python3
"""Generate 8.7.56.3015-.3018 corrected mixed-kernel return refresh artifacts."""
...
def main() -> None:
    ...
    summary = {
        ...
        "recommended_next_route_or_none": "8.7.56.3019",
        ...
        "selected_followup_route_or_none": "8.7.56.3023",
    ...
    payload = sign_base.payload(
        ...
        STEP_NAME + " declaration gate",
        {
            ...
            "routes": {
                ...
                "next_route": "8.7.56.3019",
                "followup_route": "8.7.56.3023",
            },
        },
        rows,
        summary,
