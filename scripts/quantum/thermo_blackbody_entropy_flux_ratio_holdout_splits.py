...
def main() -> None:
    ...
    out_metrics = out_dir / "thermo_blackbody_entropy_flux_ratio_holdout_splits_metrics.json"
        ...
        json.dumps(
            {
                ...
                "notes": [
                    "Analytic holdout for s/M = (16/3c) T^-1 based on blackbody entropy density and flux.",
