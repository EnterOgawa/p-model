#!/usr/bin/env python3
"""Generate 8.7.56.3063-.3066 corrected probe-split return audit artifacts."""
...
def main() -> None:
    ...
    summary = {
        ...
        "recommended_next_route_or_none": "8.7.56.3067",
        "selected_followup_route_or_none": "8.7.56.3071",
    ...
    payload = sign_base.payload(
        ...
        STEP_NAME + " declaration gate",
        {
            ...
            "routes": {
                ...
                "next_route": "8.7.56.3067",
                "followup_route": "8.7.56.3071",
            },
        },
        rows,
        summary,
