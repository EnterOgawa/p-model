#!/usr/bin/env python3
"""Generate 8.7.56.3523-.3526 corrected mixed-kernel gate / vacuum refresh artifacts."""
...
def main() -> None:
    ...
    summary = {
        ...
        "recommended_next_route_or_none": "8.7.56.3527",
        ...
        "selected_followup_route_or_none": "8.7.56.3531",
    ...
    payload = sign_base.payload(
        ...
        STEP_NAME + " declaration gate",
        {
            ...
            "routes": {
                ...
                "next_route": "8.7.56.3527",
                "followup_route": "8.7.56.3531",
            },
        },
        rows,
        summary,
