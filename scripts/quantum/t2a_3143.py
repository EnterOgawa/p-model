#!/usr/bin/env python3
"""Generate 8.7.56.3143-.3146 corrected pack-refresh return audit artifacts."""
...
def main() -> None:
    ...
    summary = {
        ...
        "recommended_next_route_or_none": "8.7.56.3147",
        ...
        "selected_followup_route_or_none": "8.7.56.3151",
    ...
    payload = sign_base.payload(
        ...
        STEP_NAME + " declaration gate",
        {
            ...
            "routes": {
                ...
                "next_route": "8.7.56.3147",
                "followup_route": "8.7.56.3151",
            },
        },
        rows,
        summary,
