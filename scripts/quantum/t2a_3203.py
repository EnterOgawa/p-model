#!/usr/bin/env python3
"""Generate 8.7.56.3203-.3206 corrected pack-refresh return gate artifacts."""
...
def main() -> None:
    ...
    summary = {
        ...
        "recommended_next_route_or_none": "8.7.56.3207",
        ...
        "selected_followup_route_or_none": "8.7.56.3211",
    ...
    payload = sign_base.payload(
        ...
        STEP_NAME + " declaration gate",
        {
            ...
            "routes": {
                ...
                "next_route": "8.7.56.3207",
                "followup_route": "8.7.56.3211",
            },
        },
        rows,
        summary,
