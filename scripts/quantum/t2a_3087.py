#!/usr/bin/env python3
"""Generate 8.7.56.3087-.3090 corrected pack-refresh return audit artifacts."""
...
def main() -> None:
    ...
    non_surrogate_guard = bool(prior_gate_summary["failure_matrix_non_surrogate_guard_preserved"])
    ...
    summary = {
        ...
        "recommended_next_route_or_none": "8.7.56.3091",
        ...
        "selected_followup_route_or_none": "8.7.56.3095",
    ...
    payload = sign_base.payload(
        ...
        STEP_NAME + " declaration gate",
        {
            ...
            "routes": {
                ...
                "next_route": "8.7.56.3091",
                "followup_route": "8.7.56.3095",
            },
        },
        rows,
        summary,
