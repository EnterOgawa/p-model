#!/usr/bin/env python3
"""Generate 8.7.56.3119-.3122 corrected probe-split return audit artifacts."""
...
def main() -> None:
    ...
    summary = {
        ...
        "recommended_next_route_or_none": "8.7.56.3123",
        "selected_followup_route_or_none": "8.7.56.3127",
    ...
    payload = sign_base.payload(
        ...
        STEP_NAME + " declaration gate",
        {
            ...
            "routes": {
                ...
                "next_route": "8.7.56.3123",
                "followup_route": "8.7.56.3127",
            },
        },
        rows,
        summary,
