"""
目的: 黒体 holdout 監査の entropy flux 指標図を再生成する。
...
def main() -> None:
    ...
    apply_blackbody_holdout_axes_text(ax, categories=categories, ylabel="test max abs(z)", title="Blackbody entropy flux holdout: J_s(T)=(c/4)s(T)")
