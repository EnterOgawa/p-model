...
def main() -> None:
    ...
    out_metrics = out_dir / "thermo_blackbody_energy_entropy_ratio_holdout_splits_metrics.json"
        ...
        json.dumps(
            {
                ...
                "notes": [
                    "Analytic holdout for u/s = (3/4) T based on blackbody energy and entropy densities.",
