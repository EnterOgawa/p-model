...
def _download(url: str, dst: Path, *, force: bool) -> None:
    ...
    print(f"[dl] {url}")
    req = urllib.request.Request(url, headers={"User-Agent": "waveP-wielgus2022-fetch/1.0"})
...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Fetch Wielgus et al. (2022) 'Millimeter light curves of Sagittarius A* observed during the 2017 EHT campaign' (PDF + arXiv source)."
    )
    ...
    row: Dict[str, Any] = {
        "key": "wielgus2022_sgra_mm_lightcurves_2017",
        "arxiv": arxiv_id,
        "label": "Wielgus et al. (2022) Millimeter light curves of Sagittarius A* observed during the 2017 EHT campaign",
        ...
        worklog.append_event(
            {
                ...
                "topic": "eht",
                "action": "fetch_wielgus2022_sgra_mm_lightcurves",
